...
using TheLegendOfZelda.States;
using TheLegendOfZelda.Inventory;
using Microsoft.Xna.Framework;
using System;

namespace TheLegendOfZelda.Players
{
    public class GoriyaPlayer : IPlayer
    {
        public Game1 Game;
        ...
        public GoriyaPlayer(Game1 game)
        {
            State = new GoriyaMainState(this);
            XPosition = 200;
            YPosition = 100 + Globals.HudOffset;
            Game = game;
            CurrentItemType = typeof(BoomerangItem);
            _invincibleTime = 0;
            PlayerHealth = 6;
            MaxPlayerHealth = 6;
