...
public class LeftItemState : AbstractPlayerState
{
    private int _timeToMove;
    private bool _itemUsed;
    private readonly int _spriteColumn;

    public LeftItemState(IPlayer player)
    {
        MyPlayer = player;
        _spriteColumn = 3;
